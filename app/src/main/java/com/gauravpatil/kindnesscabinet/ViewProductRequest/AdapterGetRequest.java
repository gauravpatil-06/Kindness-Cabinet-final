...
public class AdapterGetRequest extends BaseAdapter
{
    ...
    Activity activity;
    public AdapterGetRequest(List<POJOGetAllHistory> pojoGetAllHistories,
                             Activity activity)
    {
    ...
    public View getView(int position, View view, ViewGroup parent)
    {
        ...
        if(view == null)
        {
            ...
            view = inflater.inflate(R.layout.lv_get_request,null);
