...
public class POJOAdminGetAllHistory {
   String id,name,mobileno,emailid,address,
           username,product_category,product_image, product_name,product_cost,product_rating,product_quantity,
           product_description,product_location,product_pickup_option,product_date_and_time,role;
    public POJOAdminGetAllHistory(String id, String name, String mobileno, String emailid,
                                  String address, String username, String product_category, String product_image, String product_name, String product_cost, String product_rating, String product_quantity, String product_description, String product_location, String product_pickup_option, String product_date_and_time, String role) {
        this.id = id;
        this.name = name;
