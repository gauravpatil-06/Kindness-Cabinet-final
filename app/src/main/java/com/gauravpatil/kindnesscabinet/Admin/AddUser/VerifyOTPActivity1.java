...
public class VerifyOTPActivity1 extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
                    ...
                    FirebaseAuth.getInstance().signInWithCredential(phoneAuthCredential).
                            addOnCompleteListener(new OnCompleteListener<AuthResult>()
                            {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task)
                                {
                                    ...
                                    {
                                        progressDialog.dismiss();
                                        Toast.makeText(VerifyOTPActivity1.this, "OTP Verification Failed", Toast.LENGTH_LONG).show();
                                    }
                                }
                            });
                }
        ...
        tvResentOTP.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                PhoneAuthProvider.getInstance().verifyPhoneNumber("+91" + strMobileNo, 60, TimeUnit.SECONDS, VerifyOTPActivity1.this, new PhoneAuthProvider.OnVerificationStateChangedCallbacks()
                {
                    @Override
                    public void onVerificationCompleted(@NonNull PhoneAuthCredential phoneAuthCredential)
                    {
                        Toast.makeText(VerifyOTPActivity1.this, "Registration Completed", Toast.LENGTH_LONG).show();
                    }
                    @Override
                    public void onVerificationFailed(@NonNull FirebaseException e)
                    {
                        Toast.makeText(VerifyOTPActivity1.this, "Registration Failed", Toast.LENGTH_LONG).show();
                    }
                    @Override
                ...
                new JsonHttpResponseHandler()
                {
                    ...
                    public void onSuccess(int statusCode, Header[] headers, JSONObject response)
                    {
                        ...
                        try
                        {
                            ...
                            if(status.equals("1"))
                            {
                                Toast.makeText(VerifyOTPActivity1.this, "Registration Successfully Done", Toast.LENGTH_LONG).show();
                                Intent intent = new Intent(VerifyOTPActivity1.this, HomeAdminActivity.class);
                                startActivity(intent);
                                finish();
                            }
                            else
                            {
                                Toast.makeText(VerifyOTPActivity1.this, "Registration Fail", Toast.LENGTH_LONG).show();
                                progressDialog.dismiss();
                            }
                        }
                    ...
                    public void onFailure(int statusCode, Header[] headers, Throwable throwable, JSONObject errorResponse)
                    {
                        ...
                        Toast.makeText(VerifyOTPActivity1.this, "Server Error", Toast.LENGTH_LONG).show();
                        progressDialog.dismiss();
                    }
                });
    }
